export const RONALDO_LOGO = "/ronaldo/logo-ronaldo-leao-transparent.png";
export const RONALDO_PORTRAIT_CLOSE = "/ronaldo/ronaldo-portrait-close.jpeg";
export const RONALDO_PORTRAIT_ARMS = "/ronaldo/ronaldo-portrait-arms.jpeg";
